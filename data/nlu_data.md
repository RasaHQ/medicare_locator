...
- find me a nearby [hospital](facility_type) my zip code is [10119](zip)
...
- find me a nearby [home health agency](facility_type) my zip code is [10119](zip)
- find me a nearby [nursing home](facility_type)
- show me [nursing home](facility_type)
- [nursing home](facility_type)
- find me a nearby [nursing home](facility_type) my zip code is [10119](zip)
- i need a [hospital](facility_type) my zip code is [77494](zip)
- my zip code is [30277](zip) and i need a [nursing home](facility_type)
- my zip code is [86602](zip) and i need a [hospital](facility_type)
- my zip code is [47516](zip) and i need a [home health agency](facility_type)
- i need a [nursing home](facility_type) at [77474](zip) 
- i need a [hospital](facility_type) at [77474](zip)
- i need a [home health agency](facility_type) at [77474](zip)
- i am in [Amarillo](city) and i need a [nursing home](facility_type) 
- i am in [New York](city) and i need a [hospital](facility_type)
- i am in [Las Vegas](city) and i need a [home healt agency](facility_type)
- i need a [nursing home](facility_type) in [Katy](city) 
- i need a [hospital](facility_type) in [Waco](city)
- i need a [home health agency](facility_type) in [Clarksville](city)
- show me [nursing home](facility_type) in [Knoxville](city)
- show me [hospital](facility_type) in [Durham](city)
- show me [home health agency](facility_type) in [Detroit](city)
- find me a nearby [home health agency](facility_type) in [Reno](city)
- hi i am in [Tampa](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hi i am in [San Diego](city) i need a [hospital](facility_type:rbry-mqwu)
- hi i am in [Nashville](city) i need a [home health agenc](facility_type:9wzi-peqs)
- hi i am in [Sacramento](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hi i am in [Springfield](city) i need a [hospital](facility_type:rbry-mqwu)
- hi i am in [Atlanta](city) i need a [home health agenc](facility_type:9wzi-peqs)
- hi i am in [Chicago](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hi i am in [Santa Cruz](city) i need a [hospital](facility_type:rbry-mqwu)
- hi i am in [Boston](city) i need a [home health agenc](facility_type:9wzi-peqs)
- hello i am in [Tampa](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hello i am in [San Diego](city) i need a [hospital](facility_type:rbry-mqwu)
- hello i am in [Nashville](city) i need a [home health agenc](facility_type:9wzi-peqs)
- hello i am in [Sacramento](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hello i am in [Springfield](city) i need a [hospital](facility_type:rbry-mqwu)
- hello i am in [Atlanta](city) i need a [home health agenc](facility_type:9wzi-peqs)
- hello i am in [Chicago](city) i need a [nursing  home](facility_type:b27b-2uc7)
- hello i am in [Santa Cruz](city) i need a [hospital](facility_type:rbry-mqwu)
- hello i am in [Boston](city) i need a [home health agenc](facility_type:9wzi-peqs)
- Good morning i am in [Tampa](city) i need a [nursing  home](facility_type:b27b-2uc7)
- Good morning i am in [San Diego](city) i need a [hospital](facility_type:rbry-mqwu)
- Good morning i am in [Nashville](city) i need a [home health agenc](facility_type:9wzi-peqs)
- Good morning i am in [Sacramento](city) i need a [nursing  home](facility_type:b27b-2uc7)
- Good morning i am in [Springfield](city) i need a [hospital](facility_type:rbry-mqwu)
- Good morning i am in [Atlanta](city) i need a [home health agenc](facility_type:9wzi-peqs)
- Good morning i am in [Chicago](city) i need a [nursing  home](facility_type:b27b-2uc7)
- Good morning i am in [Santa Cruz](city) i need a [hospital](facility_type:rbry-mqwu)
- Good morning i am in [Boston](city) i need a [home health agenc](facility_type:9wzi-peqs)
- Hello again i need a [nursing home](facility_type) in [Katy](city) 
- Hello again i need a [hospital](facility_type) in [Waco](city)
- Hello again i need a [home health agency](facility_type) in [Clarksville](city)
- Good morning i need a [nursing home](facility_type) in [Katy](city) 
- Good morning i need a [hospital](facility_type) in [Waco](city)
- Good morning i need a [home health agency](facility_type) in [Clarksville](city)
- Can you tell me a [nursing home](facility_type) in [Oklahoma City](city) ?
